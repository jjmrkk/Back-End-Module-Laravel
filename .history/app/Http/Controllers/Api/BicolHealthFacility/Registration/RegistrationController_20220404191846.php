    ...
    { 
        try {
            ...
            $reg_details = DB::table('registration')->insert([
                        ...
                        'family_history_father' => json_encode($request->family_history_father),
                        'family_history_mother' => json_encode($request->family_history_mother),          
                        'lifestyle_info' => json_encode($request->lifestyle_info),
                        'present_illnesses' => json_encode($request->present_illnesses),
                        'immunization_history' => json_encode($request->immunization_history),
