...
class RecordController extends Controller
{
    ...
    { 
     ...
     try {
        ...
        {
            $lifestyle_info = DB::table('registration_maintenance')->where('category_id', 4)->select('id')->get();
        ...
        {
            $present_illnesses = DB::table('registration_maintenance')->where('category_id', 4)->select('id')->get();
        ...
        {
            $immunization_history = DB::table('registration_maintenance')->where('category_id', 4)->select('id')->get();
