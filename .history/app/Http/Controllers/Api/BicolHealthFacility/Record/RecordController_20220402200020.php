...
{
        $test1 = DB::table('registration_maintenance as a')
        ...
        ->get();
        $test1->previous_illnesses = json_decode($test1->previous_illnesses, true);

        $test2 = DB::table('registration as a')
            ->where('a.id', 2)
            ->select(
        ...
        $test2->previous_illnesses = json_decode($test2->previous_illnesses, true);
