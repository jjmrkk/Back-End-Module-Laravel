...
class RecordController extends Controller
{
    ...
    { 
        ...
        $test = '{ "user_id": 2, "id:9": true, "id:10": true, "id:11": false, "id:12": false, "id:13": true, "id:14": false }';

        try {


        $previous_illnesses = DB::table('registration_maintenance')->where('category_id', 3)->select('id')->first();

        return ($previous_illnesses);
