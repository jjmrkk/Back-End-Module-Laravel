...
class ItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $contains_empty = count($request->item_attributes_listy) != count(array_filter($request->item_attributes_list));

            return response()->json(['message' => $contains_empty], $this->errorStatus);
