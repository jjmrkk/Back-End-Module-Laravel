...
class ItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $array = array($request->item_attributes_list.['attribute_value']);
            $a = count($array);
            $b = count(array_filter($array));


            return response()->string(['message' => "$a .'-'. $b "], $this->errorStatus);
        ...
        $c = json_encode($request->item_attributes_list.['attribute_value']);
           
        return response()->json(['message' => "Empty: $request->item_attributes_list.['attribute_value']"], $this->errorStatus);
