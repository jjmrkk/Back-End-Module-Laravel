...
class ItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
           ...
           // if ($request->item_attributes_list->attribute_value == null) 
           // return response()->json(['message' => "Empty"], $this->errorStatus);
           // else
           // return response()->json(['message' => "Not Empty"], $this->errorStatus);


        return response()->json(['message' => (json_decode($request->item_attributes_list, true))], $this->errorStatus);
