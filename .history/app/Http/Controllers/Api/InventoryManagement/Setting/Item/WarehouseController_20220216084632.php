  ...
  public function store(Request $request)
  {
    ...
    try {
      ...
      if ($name_check) {
        ...
        if ($warehouse) {
          return response()->json(['message' => "Success. You have been successfully added new warehouse! Please contact system administrator for your access in newly added warehouse."], $this->successStatus);
        }
      }
