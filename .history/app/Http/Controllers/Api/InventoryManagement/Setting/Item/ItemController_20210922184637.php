    ...
    public function store(Request $request)
    {
        try {
            ...
            foreach ($request->item_attributes_list as $attribute) {
                ...
                $arrayvalue .= array($attribute['attribute_value']);
            }
            ...
            foreach ($request->item_attributes_list as $attribute) {
             ...
             return response()->json(['message' => "Emptssy: $value"], $this->errorStatus);
            }

            foreach ($arrayvalue as $value) {
                return response()->json(['message' => "Emptssy: $attribute"], $this->errorStatus);
            }

      //  $c = array($arrayvalue);

      //  return response()->json(['message' => "Emptssy: $arrayvalue"], $this->errorStatus);
