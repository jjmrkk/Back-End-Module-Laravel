    ...
    public function store(Request $request)
    {
        try {
            ...
            foreach ($request->item_attributes_list as $attribute) {
                ...
                array($arrayvalue .= ''. $attribute['attribute_value'] .= '');
            }
            $itemname_attr = ($item_name . "" . $attrname);
     
           // return response()->json(['message' => "$arrayvalue"], $this->errorStatus);

            $array = array($arrayvalue);
            if( $array  != array_filter( $array )) 
            return response()->json(['message' => "not"], $this->errorStatus);
            else
            return response()->json(['message' => "working"], $this->errorStatus);
