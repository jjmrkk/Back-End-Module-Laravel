...
class ItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
           ...
           $item_code = ($request->item_category_details_id.= "-" .$request->item_brand_id.= "-" .$request->item_model_id.= "-" .$request->item_location_id);
           return response()->json(['message' => "$item_code.= "-" .$str"], $this->errorStatus);
