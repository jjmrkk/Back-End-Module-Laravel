...
class ItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['message' => "$item_name $attrname"], $this->errorStatus);



            $name_check = DB::table('item_details')->where('name', ($item_name . ", " . $attrname))->exists();
            if ($name_check) {
                return response()->json(['message' => "Duplicate Name Entry Found for $item_name $attrname."], $this->errorStatus);
            }
