...
class ItemWarehouseCategoryController extends Controller
{
    ...
    public function ShowCategoryRelations_Test()
    {
   ...
   //     return response($str);
    ...
    public function show($id)
    {
        $maincategory = DB::table('item_category_details as e')
            ->where('e.id', $id)
            //   ->where('e.attribute_id',"=","[]")  //stopper on add sub category when they already manage the attributes
            ->select(
                'e.id',
                'e.name',
                'e.description',
