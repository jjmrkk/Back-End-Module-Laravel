...
namespace App\Http\Controllers\Api\ProcurementManagement\ProvisionRequest;
...
class ItemRequestHeaderController extends Controller
{
    ...
    public function show($id)
    {
        try {
            ...
            return response()->json(['itemRequest'=>$itemRequestHeader,'items'=>$items], $this->successStatus);
        } catch (Exception $e) {
