...
namespace App\Http\Controllers\Api\ProvisionRequest\ForApproval\Tagged;
                ...
                $itemRequestHeaders = DB::table('item_request_headers as header')
                                            ->where(function ($query) use ($firstApprovals, $secordApprovals) {
                                                if($firstApprovals)
                                                {
                                                    ...
                                                    {
                                                        $query->orWhere('header.status_id', 4)
                                                ...
                                                if($secordApprovals)
                                                {
                                                    ...
                                                    {
                                                        $query->orWhere('header.status_id', 7)
