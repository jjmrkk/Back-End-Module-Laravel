...
<tr>
	...
	<tr>
		<td style="font-size: 8px !important;">&nbsp; Email: 
...
<table style="border-width: .2px .2px .2px .2px !important" width="100%" cellpadding="0">
	   ...
	   <tr><th width="100%"></th></tr>
	<tr>
		<td style="font-size: 8px !important;">&nbsp; Registration No.: <b>{{ $info->registration_no }}</b></td>
	</tr>
	<tr>
		<td style="font-size: 8px !important;">&nbsp; Date Registered: <b>{{ $info->created_at }}</b></td>
	</tr>
	<tr>
		<td style="font-size: 8px !important;">&nbsp; Name: <b>{{ $info->last_name }}, {{ $info->first_name }} {{ $info->middle_name }}</b></td>
	</tr>
	...
	<tr>
		<td style="font-size: 8px !important;">&nbsp; PhilHealth Konsulta Facility: <b>Bicol True Value Diagnostic Facility, Inc.</b></td>
	</tr>
	<tr>
