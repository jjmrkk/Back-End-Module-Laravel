	...
	<tr>
	 ...
	 <table border="0" width="100%" cellpadding="5">
		...
		@endforeach
			...
			<tr>
				<th width="100%" style="border-left-width: 0.1px; border-right-width: 0.1px; border-top-width: 0.1px; border-bottom-width: 0.1px; text-align: center; font-size: 8px !important"><br><br>No record Found<br></th>
			</tr>
