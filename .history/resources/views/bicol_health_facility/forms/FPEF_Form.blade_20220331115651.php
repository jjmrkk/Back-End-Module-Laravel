...
<tr>
	...
	<tr>
		<th width="25%" style="text-align: left; font-size: 8px !important">&nbsp;Date of Birth: <b>{{ date('M d, Y', strtotime($info->date_of_birth)) }}</b></th>
	...
	@foreach(json_decode($info->previous_illnesses_array) as $a)
	<tr>
