...
<tr>
	...
	<table border="0.0" width="100%" cellpadding="0">
		...
		<tr>
			<th width="1%"></th>
			<th width="14%" style="text-align: left; position:relative !important">&nbsp;&nbsp;<img src="{{ public_path('img/BHF.jpg') }}" alt="Logo" width="70" height="70" class="logo"/></th>
			<th width="74%" style="text-align: left; font-size: 10px !important"><b><br>BICOL TRUE VALUE DIAGNOSTIC FACILITY, INC<br>First Patient Encounter Form (FPEF)</b></th>
	...
	<tr>
		...
		<th width="25%" style="text-align: left; font-size: 8px !important">Membership Category: <b>{{ $info->membership_category }}</b></th>
		<th width="25%" style="text-align: left; font-size: 8px !important">Date registered: <b>{{ date('M d, Y', strtotime($info->created_at)) }}</b></th>
	</tr>
	<tr><th width="100%"></th></tr>
	<tr>
	...
	<tr>
		<th width="25%" style="text-align: left; font-size: 8px !important">&nbsp;Date of Birth: <b>{{ date('M d, Y', strtotime($info->date_of_birth)) }} - {{ $age }}y/o</b></th>
	...
	<tr>
	 ...
	 <table border="0" width="100%" cellpadding="5">
		...
		@endforeach
			@else
			<tr>
				<th width="100%" style="border-left-width: 0.1px; border-right-width: 0.1px; border-top-width: 0.1px; border-bottom-width: 0.1px; text-align: center; font-size: 8px !important"><br><br><b>No record Found.</b><br></th>
			</tr>
		@endif
	...
	<tr><th width="100%"></th></tr>
	 ...
	 <tr><th width="100%"></th></tr>
	 <tr>
		<th width="21%" style="text-align: left; font-size: 9px !important">&nbsp;<b>Registration Number:</b></th>
		<th width="21%" style="text-align: left; font-size: 9px !important">&nbsp;<b>ATC Number:</b></th>
	</tr>	
	<tr>
		<td width="21%" style="text-align: left; font-size: 9px !important">

	@if($info->registration_no != null)
	&nbsp;{{ $info->registration_no }}<br>
	@else
	&nbsp;N/A
	@endif
	...
	<tr><th width="100%"></th></tr>
	<tr><td width="100%" style="font-size: 8px !important;">________________________________________________________________________________________________________________________________</td></tr>
	<tr><th width="100%"></th></tr>
	<tr>
	...
	<tr>
		<th width="70%"></th>
		<td width="30%" style="float: right; font-size: 8px !important;">&nbsp;Verified by: <b>{{ $info->v_last_name }}, {{ $info->v_first_name }} {{ $info->v_middle_name }}</b></td>
	</tr>
</table>
</th>
</tr>
